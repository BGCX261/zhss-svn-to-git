...
// PHPMaker 5 configuration for Table archives
$archives = new carchives; // Initialize table object
...
class carchives {
	...
	function carchives() {
		$this->TableVar = "archives";
		$this->TableName = "archives";
		$this->SelectLimit = TRUE;
		$this->id = new cField('archives', 'x_id', 'id', "`id`", 3, -1, FALSE);
		$this->fields['id'] =& $this->id;
		$this->url = new cField('archives', 'x_url', 'url', "`url`", 200, -1, FALSE);
		$this->fields['url'] =& $this->url;
		$this->projectname = new cField('archives', 'x_projectname', 'projectname', "`projectname`", 200, -1, FALSE);
		$this->fields['projectname'] =& $this->projectname;
		$this->title = new cField('archives', 'x_title', 'title', "`title`", 200, -1, FALSE);
		$this->fields['title'] =& $this->title;
		$this->datetime = new cField('archives', 'x_datetime', 'datetime', "`datetime`", 135, 5, FALSE);
		$this->fields['datetime'] =& $this->datetime;
		$this->content = new cField('archives', 'x_content', 'content', "`content`", 201, -1, FALSE);
	...
	function InsertSQL(&$rs) {
		...
		return "INSERT INTO `archives` ($names) VALUES ($values)";
	}
	...
	// View url
	function ViewUrl() {
		return $this->KeyUrl("archivesview.php");
	}

	// Edit url
	function EditUrl() {
		return $this->KeyUrl("archivesedit.php");
	}

	// Inline edit url
	function InlineEditUrl() {
		return $this->KeyUrl("archiveslist.php", "a=edit");
	}

	// Copy url
	function CopyUrl() {
		return $this->KeyUrl("archivesadd.php");
	}

	// Inline copy url
	function InlineCopyUrl() {
		return $this->KeyUrl("archiveslist.php", "a=copy");
	}

	// Delete url
	function DeleteUrl() {
		return $this->KeyUrl("archivesdelete.php");
	}
