...
define("EW_CONN_DB", "spider", TRUE);
define("RY_BAK_HTML", "D:\\WebSpider\\Html", TRUE);
...
define("EW_PROJECT_NAME", "rying", TRUE); // Project Name
define("EW_RANDOM_KEY", '8yh4hTL7WoY1f838', TRUE); // Random key for encryption
...
define("EW_TABLE_BASIC_SEARCH_START_TIME", "starttime", TRUE);
define("EW_TABLE_BASIC_SEARCH_END_TIME", "endtime", TRUE);
define("EW_TABLE_BASIC_SEARCH_SCOPE", "searchscope", TRUE);
define("EW_TABLE_BASIC_SEARCH_PROJECTNAME", "projectname", TRUE);
define("EW_TABLE_BASIC_SEARCH_CATEGORY", "category", TRUE);
...
define("EW_ALLOW_ARCHIVE", 3, TRUE); // Delete
