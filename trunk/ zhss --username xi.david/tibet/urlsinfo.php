...
// PHPMaker 5 configuration for Table urls
$urls = new curls; // Initialize table object
...
class curls {
	...
	function curls() {
		...
		$this->id = new cField('urls', 'x_id', 'id', "`id`", 3, -1, FALSE);
		$this->fields['id'] =& $this->id;
		$this->url = new cField('urls', 'x_url', 'url', "`url`", 200, -1, FALSE);
		$this->fields['url'] =& $this->url;
		$this->digest = new cField('urls', 'x_digest', 'digest', "`digest`", 200, -1, FALSE);
		$this->fields['digest'] =& $this->digest;
		$this->type = new cField('urls', 'x_type', 'type', "`type`", 3, -1, FALSE);
	...
	function InsertSQL(&$rs) {
		...
		return "INSERT INTO `urls` ($names) VALUES ($values)";
	}
	...
	// View url
	function ViewUrl() {
		return $this->KeyUrl("urlsview.php");
	}

	// Edit url
	function EditUrl() {
		return $this->KeyUrl("urlsedit.php");
	}

	// Inline edit url
	function InlineEditUrl() {
		return $this->KeyUrl("urlslist.php", "a=edit");
	}

	// Copy url
	function CopyUrl() {
		return $this->KeyUrl("urlsadd.php");
	}

	// Inline copy url
	function InlineCopyUrl() {
		return $this->KeyUrl("urlslist.php", "a=copy");
	}

	// Delete url
	function DeleteUrl() {
		return $this->KeyUrl("urlsdelete.php");
	}
